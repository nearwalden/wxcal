...
file_loc = "/mnt/c/Users/nearw/data/temperature/"
...
def lat_lon_files(dir, short_name):
    files = []
    for lat in range(25, 49, 5):
        for lon in range(-119, -60, 5):
            files.append(dir + short_name + "all_" + lat_str(lat) +
                         "_" + lon_str(lon) + "_temp.csv")
    return files


cols_to_remove = ['Unnamed: 0', 'time', 'year', 'month', 'day',
                  'day_of_year', 'mean']
